      ...
      <form action="" method="post" class="form-signin">
		<fieldset>
			...
			<div class="row-fluid wukong">
				<div class="span3"><img style="height:50px;" src="./Public/img/logo_img.png" alt="简信CRM"/></div>
				<div class="span9">
					<p>简信CRM &copy; 郑州简信件科技有限公司 2013</p>
					<p><small>
						<a href="http://crm.cc/index.php?m=doc" target="_blank">使用帮助</a>
						<span class="muted">&middot;</span>
						<a href="http://www.crm.cc/" target="_blank">技术支持</a>
						<span class="muted">&middot;</span>
