...
('defaultinfo', 'a:8:{s:4:"name";s:9:"简信CRM";s:11:"description";s:39:"开源免费的客户关系管理系统";s:5:"state";s:9:"河南省";s:4:"city";s:9:"郑州市";s:15:"allow_file_type";s:40:"pdf,doc,jpg,png,gif,txt,doc,xls,zip,docx";s:19:"contract_alert_time";i:30;s:10:"task_model";s:1:"2";s:4:"logo";N;}', ''),
...
(1, '线索', 'http://demo.crm.cc/index.php?m=leads', 'top', 0, 'Leads'),
(2, '客户', 'http://demo.crm.cc/index.php?m=customer', 'top', 1, 'Customer'),
(3, '商机', 'http://demo.crm.cc/index.php?m=business', 'top', 2, 'Business'),
(4, '产品', 'http://demo.crm.cc/index.php?m=product', 'top', 3, 'Product'),
(5, '任务', 'http://demo.crm.cc/index.php?m=task', 'top', 4, 'Task'),
(6, '日程', 'http://demo.crm.cc/index.php?m=event', 'top', 5, 'Event'),
(7, '合同', 'http://demo.crm.cc/index.php?m=contract', 'top', 6, 'Contract'),
(8, '财务', 'http://demo.crm.cc/index.php?m=finance', 'top', 7, 'Finance'),
(9, '日志', 'http://demo.crm.cc/index.php?m=log', 'more', 0, ''),
(10, '知识', 'http://demo.crm.cc/index.php?m=knowledge', 'more', 1, 'Knowledge'),
(11, '营销', 'http://demo.crm.cc/index.php?m=setting&a=sendsms', 'more', 2, ''),
(12, '站内信', 'http://demo.crm.cc/index.php?m=message', 'more', 3, ''),
(13, '我的面板', 'http://demo.crm.cc/', 'user', 0, ''),
(14, '个人资料', 'http://demo.crm.cc/index.php?m=user&a=edit', 'user', 1, ''),
(15, '组织架构', 'http://demo.crm.cc/index.php?m=user', 'user', 2, ''),
(16, '权限分配', 'http://demo.crm.cc/index.php?m=user&a=role', 'user', 3, 'Role'),
(17, '公告管理', 'http://demo.crm.cc/index.php?m=announcement', 'user', 4, 'announcement'),
(18, '操作日志', 'http://demo.crm.cc/index.php?m=action_log', 'user', 5, ''),
(19, '系统设置', 'http://demo.crm.cc/index.php?m=setting', 'user', 6, 'Setting');
